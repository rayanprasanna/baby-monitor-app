...
public class Header1_5Activity extends AppCompatActivity {
    ImageButton nextImgeBtn,previousImgBtn;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_header1_5);
        ...
        naviText.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                //Intent intent=new Intent(Header1_5Activity.this,Header1Activity.class);
        ...
        nextImgeBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(Header1_5Activity.this,Header1_6Activity.class);
                startActivity(intent);
                finish();
            }
        });
        previousImgBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(Header1_5Activity.this,Header1_4Activity.class);
                startActivity(intent);
                finish();
            }
        });
