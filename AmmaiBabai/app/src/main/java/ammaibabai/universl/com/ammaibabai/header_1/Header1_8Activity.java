...
public class Header1_8Activity extends AppCompatActivity {
    ImageButton nextImgeBtn,previousImgBtn;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_header1_8);
        TextView naviText= (TextView) findViewById(R.id.txtClose);

        naviText.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                //Intent intent=new Intent(Header1_8Activity.this,Header1Activity.class);
        ...
        nextImgeBtn.setEnabled(false);
        previousImgBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(Header1_8Activity.this,Header1_7Activity.class);
                startActivity(intent);
                finish();
            }
        });
